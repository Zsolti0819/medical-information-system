...
//        String query = "SELECT * from patients WHERE deleted=false;";
        String query = "select patients.*, appointments.start_time from patients left join appointments on appointments.patient_id = patients.id and appointments.start_time > now() and patients.deleted=false and appointments.deleted=false;";
